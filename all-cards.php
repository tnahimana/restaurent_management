...
<head>
    ...
    <title>Card Modification | UTB Resto</title>
    ...
    <link rel="stylesheet" href="./charts/css/all-card.css">
...
<h4><strong>Users</strong></h4>
 ...
 <?php
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM card_modification";
        $result = mysqli_query($con,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $sql = "SELECT * FROM card_modification order by register_date DESC LIMIT $offset, $no_of_records_per_page";
        ...
        while($row = mysqli_fetch_array($res_data)){
            //here goes the data
                    ...
                    $pr_card = $row['previous_card'];
                    $rc_card = $row['recent_card'];
  ...
  <tr style="text-align: right;">
                ...
                <td class="lower"><?php echo $mail; ?></td>
                <td><?php echo $pr_card; ?></td>
                <td><?php echo $rc_card; ?></td>
