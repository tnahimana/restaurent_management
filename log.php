...
<head>
    ...
    <title>Users Activities | UTB Resto</title>
    ...
    <link rel="stylesheet" href="./charts/css/log.css">
...
<h4><strong>User Activities</strong></h4>
 ...
 <table class="table-bordered table pull-right" id="mytable" cellspacing="0" style="width: 100%;">
  ...
  <?php
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM users_activity";
        $result = mysqli_query($con,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);

        $sql = "SELECT * FROM users_activity order by register_date DESC  LIMIT $offset, $no_of_records_per_page";
        ...
        while($row = mysqli_fetch_array($res_data)){
            ...
            $sel_out = mysqli_query($con, "select * from user_logout where activity_id = '$act_id' order by activity_id DESC");
            while($row = mysqli_fetch_array($sel_out)){
                    $out = $row['register_date'];
  ...
  <div class="container">
         ...
         <a style="margin-left: -20px;" class="btn btn-outline-success" href="log-chart.php">View Chart<a>
         </div>
     </div>
<br>
